...
const Seekbar = ({ value, min, max, onInput, setSeekTime, appTime }) => {
  ...
  return (
    <div className="hidden sm:flex flex-row items-center">
      ...
      <input type="range" step="any" value={value} min={min} max={max} onInput={onInput} className="md:block w-24 md:w-56 2xl:w-96 h-1 mx-4 2xl:mx-6 rounded-lg accent-[#db9d00] white" />
